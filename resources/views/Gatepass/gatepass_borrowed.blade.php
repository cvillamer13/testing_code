                    ...
                    {{-- <form  method="POST" action="./{{ $data_gatepass->id }}" enctype="multipart/form-data"> --}}
                        ...
                        <div class="card py-3 px-3">
                            <div class="row">
                                ...
                                <div class="col-md-6  text-center border border-primary">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label for="rev_no" class="form-label">Department</label><br>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    @foreach ($data_issuance->details as $index => $asset)
                                        <tr>
                                            <td>{{ $asset->asset_details->asset_id }}</td>
                                            <td>{{ $asset->asset_details->asset_description }}</td>
                                            <td>{{ $asset->asset_details->serial_number }}</td>
                                            <td>{{ $asset->asset_details->unit_data ? $asset->asset_details->unit_data->name : 'N/A' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
