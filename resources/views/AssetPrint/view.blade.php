                                ...
                                <tbody id="change_data">
                                    @foreach($asset as $ass)
                                        <tr>
                                            ...
                                            <td><a class="badge badge-lg badge-info" id="staff_id_new" onclick="print_one({{ $ass->id }})"><i class="fa fa-print"></i>print</a></td>
                                        </tr>
                                    @endforeach
                            </table>
                        </div>
