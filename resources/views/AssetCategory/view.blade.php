<x-app-layout>
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title col-6">All Asset Category</h4>
                                ...
                                <td>
                                    <button type="button" class="badge badge-lg badge-info">
                                        ...
                                        <a data-toggle="modal" id="staff_id_new"
                                            ...
                                            data-name="{{ $cat->name }}"
                                            data-id="{{ $cat->id }}"><i class="la la-pencil"></i>
                                            Edit</a>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" class="form-control" id="name_edit" placeholder="Category Name" name="name_edit" required>
                        </div>
                    </div>
