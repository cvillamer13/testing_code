                    ...
                    <tr>
                        <td>
                            ...
                            <table role="presentation" width="100%" align="center">
                                <tr>
                                    <td align="center">
                                        <a href="{{ url('/AssetAssign/view_rev/'. $rev_num . '/A' . '/'. $pages_id  .'/'. $user_id ) }}" style="display: inline-block; padding: 10px 20px; background-color: #28a745; color: #ffffff; text-decoration: none; border-radius: 5px; margin-right: 10px;">Approve Request</a>
                                        <a href="{{ url('/AssetAssign/view_rev/'. $rev_num . '/D' . '/'. $pages_id  .'/'. $user_id ) }}" style="display: inline-block; padding: 10px 20px; background-color: #dc3545; color: #ffffff; text-decoration: none; border-radius: 5px;">Reject Request</a>
                                    </td>
                                </tr>
                            </table>
