                    ...
                    <tr>
                        <td>
                            ...
                            <table role="presentation" width="100%" style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px; text-align: center;">
                                ...
                                <tbody>
                                    @foreach ($data->details as $as)
                                    <tr style="background-color: #f9f9f9;">
                                        <td style="padding: 10px; border: 1px solid #ddd;">{{  $as->asset_details->asset_id }}</td>
                                        <td style="padding: 10px; border: 1px solid #ddd;">{{  $as->asset_details->asset_description }}</td>
                                        <td style="padding: 10px; border: 1px solid #ddd;">{{  $as->asset_details->serial_number }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
