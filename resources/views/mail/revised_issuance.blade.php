        ...
        <tr>
            <td align="center">
                <table role="presentation" style="max-width: 600px; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <tr>
                        <td align="center">
                            <h2 style="color: #1b4fd3;">Issuance Request Notification</h2>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p>Dear {{ $name }},</p>
                            <p>Your issuance request (Issuance No: <a href="{{ url('/AssetAssign/detl/'. $issued_id ) }}" target="_blank">{{ $rev_num }}</a> ) has been disapproved. Please review the</p>
