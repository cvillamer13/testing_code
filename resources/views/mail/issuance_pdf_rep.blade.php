...
<p style="text-align: center;">
    ...
    <a href="{{ url('/AssetAssign/recieved/'. $data_show->id ."/R/".$data_show->getEmployee->id) }}" target="_blank"
        style="
            display: inline-flex;
            align-items: center;
        ...
        >
        <i class="fas fa-door-open" style="margin-right: 8px;"></i> Click this to recieved
        </a>
